...
module.exports = ({ file }) => {
  const isAntdMobile=file.dirname.includes(path.join('node_modules', 'antd-mobile'))
  const designWidth = isAntdMobile ? 375 : 750;
  const designHeight = isAntdMobile ? 667 : 1334;
